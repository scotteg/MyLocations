...
- (void)configureGetButton
{
  if (_updatingLocation) {
    ...
    if (!_spinner) {
      ...
      _spinner.center = CGPointMake(self.messageLabel.center.x, self.messageLabel.center.y + CGRectGetHeight(_spinner.bounds) / 2.0f + 15.0f);
...
- (void)showLogoView
{
  ...
  _logoButton.center = CGPointMake(CGRectGetWidth(self.view.bounds) / 2.0f, CGRectGetHeight(self.view.bounds) / 2.0f - 49.0f);
...
- (void)hideLogoView
{
  ...
  self.containerView.center = CGPointMake(CGRectGetWidth(self.view.bounds) * 2.0f, 40.0f + CGRectGetHeight(self.containerView.bounds) / 2.0f);
...
- (void)locationManager:(CLLocationManager *)manager didUpdateLocations:(NSArray *)locations
{
  ...
  if (!_location || _location.horizontalAccuracy > newLocation.horizontalAccuracy) {
    _lastLocationError = nil;
